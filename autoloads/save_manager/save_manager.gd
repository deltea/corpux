...
func get_level_time(level_name: String) -> Variant:
...
func get_level_rank(level_name: String) -> Variant:
	var base_path := "level_%s_" % level_name
...
func get_level_secret(level_name: String) -> Variant:
	var base_path := "level_%s_" % level_name
...
func update_level_data(level_name: String, new_time: float, new_rank: String, new_secret: bool) -> void:
	var base_path := "level_%s_" % level_name
...
func get_player_username() -> Variant:
	if game_data.has("player_username"):
		return game_data["player_username"]
	return null


func set_player_username(new_username: String) -> void:
